      ...
      <header className="sticky top-0 z-50 border-b border-white/10 bg-black/50 backdrop-blur-xl">
        ...
        >
          ...
          <div className="hidden items-center gap-5 text-sm md:flex">
            {navItems.map((item) => (
              <Link key={item.href} href={item.href} className="text-white/85 transition hover:text-[#FF3131]">
                {item.label}
              </Link>
            ))}
          </div>
      ...
      <main>
        <section id="hero" className="relative flex min-h-screen items-center">
          ...
          <div className="mx-auto grid w-full max-w-6xl gap-10 px-4 py-24 sm:px-6 lg:grid-cols-2 lg:items-center">
            <div className="relative z-10">
              <p className="mb-4 text-sm uppercase tracking-[0.2em] text-white/70">Portimao, Portugal</p>
              ...
              <div className="mt-10 flex flex-wrap gap-8">
                <div>
                  ...
                  <p className="text-sm text-white/70">Professional Simulators</p>
                </div>
                <div>
                  <p className="font-heading text-3xl font-bold text-[#FF3131]">
                    <NumberTicker value={42} suffix={'"'} />
                  </p>
                  <p className="text-sm text-white/70">Triple OLED Display</p>
                </div>
                <div>
                  <p className="font-heading text-3xl font-bold text-[#FF3131]">
                    <NumberTicker value={5090} />
                  </p>
                  <p className="text-sm text-white/70">RTX-Powered Rig</p>
                </div>
              </div>
            </div>
            <div className="relative z-10">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            {services.map((service) => (
              <MagicCard key={service.title}>
                ...
                <p className="mt-3 text-white/80">{service.text}</p>
              </MagicCard>
            ))}
          </div>
        </section>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            <Card>
              ...
              <CardContent>
                ...
                <p className="mt-2 text-sm text-white/70">EUR49.50 per hour</p>
              </CardContent>
            </Card>
            <Card className="relative border-[#FF3131]/40">
              ...
              <CardContent>
                ...
                <p className="mt-2 text-sm text-white/70">EUR40 per hour</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader>
              ...
              <CardContent>
                ...
                <p className="mt-2 text-sm text-white/70">EUR35 per hour</p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="mt-6 grid gap-6 lg:grid-cols-2">
            <MagicCard>
              <p className="text-white/85">
                Founded by Gabor and Jussi, lifelong petrolheads and racers. They own KZ2 and Rotax DD2 race karts at Kartodromo Internacional do Algarve and train almost every week.
              </p>
              <p className="mt-4 text-white/85">
                They regularly participate in track days at Autodromo Internacional do Algarve and other circuits across Europe, driving both GT and Formula cars.
              </p>
            </MagicCard>
            <MagicCard>
              ...
              <p className="mt-4 text-white/70">Gabor and Jussi, Algarve SimRacing</p>
            </MagicCard>
          </div>
        </section>
        ...
        <section id="contact" className="mx-auto w-full max-w-6xl px-4 py-20 sm:px-6">
          <MagicCard className="relative overflow-hidden">
            ...
            <p className="relative z-10 mt-3 max-w-2xl text-white/80">
